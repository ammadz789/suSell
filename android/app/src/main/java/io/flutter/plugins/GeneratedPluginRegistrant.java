...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new io.litosoft.flutter.firebase_installations.FirebaseInstallationsPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin firebase_installations, io.litosoft.flutter.firebase_installations.FirebaseInstallationsPlugin", e);
    }
    try {
